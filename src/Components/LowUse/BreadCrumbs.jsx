  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="/dashboard/Productos" class="ms-1 text-sm font-medium   md:ms-2 text-gray-400 hover:text-white">Productos</a>
      </div>
    </li>
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <span class="ms-1 text-sm font-medium md:ms-2 text-gray-400">{children}</span>
      </div>
    </li>
  </ol>
</nav>
